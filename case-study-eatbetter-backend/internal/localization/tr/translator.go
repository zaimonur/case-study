...
const RulesetVersion = "tr-usda-v3"
...
func translateModifier(family, clause string) (string, bool) {
	...
	if (family == "Waffle" || family == "Yogurt") && normalized == "fruit" {
		return "meyveli", true
	}
...
var safeFamilies = map[string]familyTranslation{
	...
	"Chocolate candy":           {display: "çikolatalı şekerleme"},
	...
	"Coffee creamer":            {display: "kahve kreması"},
	...
	"Figs":                      {display: "incir"},
	"Flour":                     {display: "un"},
	"Frozen coffee drink":       {display: "dondurulmuş kahve içeceği"},
	"Frozen mocha coffee drink": {display: "dondurulmuş mocha kahve içeceği"},
	"Fruit flavored drink":      {display: "meyve aromalı içecek"},
	...
	"Ice cream":                 {display: "dondurma"},
	"Ice creams":                {display: "dondurma"},
	...
	"Millet":                    {display: "darı"},
	"Milk":                      {display: "süt"},
	"Muffin":                    {display: "muffin"},
	"Muffins":                   {display: "muffin"},
	...
	"Orange juice":              {display: "portakal suyu"},
	"Oats":                      {display: "yulaf"},
	...
	"Peas and carrots":          {display: "bezelye ve havuç"},
	...
	"Potato chips":              {display: "patates cipsi"},
	"Pretzels":                  {display: "pretzel"},
	...
	"Roll":                      {display: "küçük ekmek"},
	"Rolls":                     {display: "küçük ekmek"},
	...
	"Soft drink":                {display: "gazlı içecek"},
	...
	"Waffle":                    {display: "waffle"},
	"Waffles":                   {display: "waffle"},
...
var familyQualifiers = map[string]map[string]familyTranslation{
	"Bagel": {
		"multigrain":        {display: "çok tahıllı bagel ekmeği"},
		"oat bran":          {display: "yulaf kepekli bagel ekmeği"},
		"pumpernickel":      {display: "pumpernickel bagel ekmeği"},
		"wheat":             {display: "buğdaylı bagel ekmeği"},
		"wheat bran":        {display: "buğday kepekli bagel ekmeği"},
		"whole grain white": {display: "tam tahıllı beyaz bagel ekmeği"},
		"whole wheat":       {display: "tam buğdaylı bagel ekmeği"},
	},
	"Beans": {
		"adzuki":         {display: "adzuki fasulyesi"},
		"black turtle":   {display: "siyah kaplumbağa fasulyesi"},
		"great northern": {display: "great northern fasulyesi"},
	...
	"Cabbage": {
		"savoy": {display: "savoy lahanası"},
	},
	"Candy": {
		"caramel":               {display: "karamel"},
		"cotton":                {display: "pamuk şeker"},
		"fruit flavored pieces": {display: "meyve aromalı şekerleme parçaları"},
		"fruit leather":         {display: "meyve pestili"},
		"fruit snacks":          {display: "meyveli şekerleme"},
		"gummy":                 {display: "jelibon"},
		"hard":                  {display: "sert şeker"},
		"licorice":              {display: "meyan kökü şekerlemesi"},
		"lollipop":              {display: "lolipop"},
		"marshmallow":           {display: "marşmelov"},
		"mint":                  {display: "naneli şeker"},
		"non chocolate":         {display: "çikolatasız şekerleme"},
		"nougat with nuts":      {display: "kuruyemişli nuga"},
		"peanut brittle":        {display: "yer fıstıklı krokan"},
		"sprinkles":             {display: "şeker süsü"},
		"taffy":                 {display: "taffy şekerlemesi"},
	},
	"Bread": {
	...
	"Coffee creamer": {
		"liquid": {display: "sıvı kahve kreması"},
		"powder": {display: "toz kahve kreması"},
		"soy":    {display: "soya bazlı kahve kreması"},
	},
	"Crackers": {
	...
	"Ice cream": {
		"fried":      {display: "kızartılmış dondurma"},
		"soft serve": {display: "yumuşak dondurma"},
	},
	"Ice creams": {
		"french vanilla": {display: "Fransız vanilyalı dondurma"},
	},
	"Cream": {
	...
	"Lima beans": {
		"large": {display: "iri lima fasulyesi"},
	},
	"Muffin": {
		"blueberry":         {display: "yaban mersinli muffin"},
		"carrot":            {display: "havuçlu muffin"},
		"cheese":            {display: "peynirli muffin"},
		"chocolate":         {display: "çikolatalı muffin"},
		"chocolate chip":    {display: "çikolata parçacıklı muffin"},
		"english":           {display: "İngiliz muffini"},
		"english\x00cheese": {display: "peynirli İngiliz muffini"},
		"fruit":             {display: "meyveli muffin"},
		"oat bran":          {display: "yulaf kepekli muffin"},
		"oatmeal":           {display: "yulaf ezmeli muffin"},
		"plain":             {display: "sade muffin"},
		"pumpkin":           {display: "bal kabaklı muffin"},
		"wheat":             {display: "buğdaylı muffin"},
		"wheat bran":        {display: "buğday kepekli muffin"},
		"whole grain":       {display: "tam tahıllı muffin"},
		"whole wheat":       {display: "tam buğdaylı muffin"},
		"zucchini":          {display: "kabaklı muffin"},
	},
	"Muffins": {
		"blueberry":              {display: "yaban mersinli muffin"},
		"corn":                   {display: "mısırlı muffin"},
		"english\x00wheat":       {display: "buğdaylı İngiliz muffini"},
		"english\x00whole-wheat": {display: "tam buğdaylı İngiliz muffini"},
		"oat bran":               {display: "yulaf kepekli muffin"},
		"wheat bran":             {display: "buğday kepekli muffin"},
	},
	"Mushroom": {
	...
	"Orange juice": {
		"canned":             {display: "konserve portakal suyu"},
		"chilled":            {display: "soğutulmuş portakal suyu"},
		"frozen concentrate": {display: "dondurulmuş portakal suyu konsantresi"},
		"no pulp":            {display: "posasız portakal suyu"},
	},
	"Peas": {
		"edible-podded": {display: "kabuğuyla yenen bezelye"},
	},
	"Pancakes": {
		"blueberry":   {display: "yaban mersinli pankek"},
		"buckwheat":   {display: "karabuğdaylı pankek"},
		"buttermilk":  {display: "yayık altı sütlü pankek"},
		"chocolate":   {display: "çikolatalı pankek"},
		"fruit":       {display: "meyveli pankek"},
		"gluten free": {display: "glutensiz pankek"},
		"gluten-free": {display: "glutensiz pankek"},
		"plain":       {display: "sade pankek"},
		"pumpkin":     {display: "bal kabaklı pankek"},
		"school":      {display: "okul yemeği pankeki"},
		"whole grain": {display: "tam tahıllı pankek"},
		"whole wheat": {display: "tam buğdaylı pankek"},
		"whole-wheat": {display: "tam buğdaylı pankek"},
	},
	"Peppers": {
		"bell":      {display: "dolmalık biber"},
		"chili":     {display: "şili biberi"},
		"hot chile": {display: "acı şili biberi"},
		"hot chili": {display: "acı şili biberi"},
	...
	"Potato chips": {
		"baked":        {display: "fırınlanmış patates cipsi"},
		"popped":       {display: "patlatılmış patates cipsi"},
		"restructured": {display: "yeniden şekillendirilmiş patates cipsi"},
		"ruffled":      {display: "tırtıklı patates cipsi"},
	},
	"Potatoes": {
		"hash brown": {display: "hash brown patates"},
	},
	"Roll": {
		"cheese":                               {display: "peynirli küçük ekmek"},
		"diet":                                 {display: "diyet küçük ekmek"},
		"egg bread":                            {display: "yumurtalı küçük ekmek"},
		"garlic":                               {display: "sarımsaklı küçük ekmek"},
		"gluten free":                          {display: "glutensiz küçük ekmek"},
		"mexican\x00bolillo":                   {display: "Meksika bolillo ekmeği"},
		"multigrain":                           {display: "çok tahıllı küçük ekmek"},
		"multigrain\x00hamburger bun":          {display: "çok tahıllı hamburger ekmeği"},
		"multigrain\x00hot dog bun":            {display: "çok tahıllı sosisli sandviç ekmeği"},
		"oatmeal":                              {display: "yulaf ezmeli küçük ekmek"},
		"pumpernickel":                         {display: "pumpernickel küçük ekmeği"},
		"rye":                                  {display: "çavdarlı küçük ekmek"},
		"sour dough":                           {display: "ekşi mayalı küçük ekmek"},
		"sweet\x00cinnamon bun\x00frosted":     {display: "üzeri şeker kaplamalı tarçınlı tatlı küçük ekmek"},
		"sweet\x00cinnamon bun\x00no frosting": {display: "üzeri şekersiz tarçınlı tatlı küçük ekmek"},
		"sweet\x00frosted":                     {display: "üzeri şeker kaplamalı tatlı küçük ekmek"},
		"sweet\x00no frosting":                 {display: "üzeri şekersiz tatlı küçük ekmek"},
		"sweet\x00with fruit\x00frosted":       {display: "üzeri şeker kaplamalı meyveli tatlı küçük ekmek"},
		"white\x00hamburger bun":               {display: "beyaz hamburger ekmeği"},
		"white\x00hard":                        {display: "sert beyaz küçük ekmek"},
		"white\x00hoagie\x00submarine":         {display: "beyaz hoagie/submarine sandviç ekmeği"},
		"white\x00hot dog bun":                 {display: "beyaz sosisli sandviç ekmeği"},
		"white\x00soft":                        {display: "yumuşak beyaz küçük ekmek"},
		"whole grain white":                    {display: "tam tahıllı beyaz küçük ekmek"},
		"whole grain white\x00hamburger bun":   {display: "tam tahıllı beyaz hamburger ekmeği"},
		"whole grain white\x00hot dog bun":     {display: "tam tahıllı beyaz sosisli sandviç ekmeği"},
		"whole wheat":                          {display: "tam buğdaylı küçük ekmek"},
		"whole wheat\x00hamburger bun":         {display: "tam buğdaylı hamburger ekmeği"},
		"whole wheat\x00hot dog bun":           {display: "tam buğdaylı sosisli sandviç ekmeği"},
	},
	"Rolls": {
		"dinner\x00egg":                  {display: "yumurtalı yemeklik küçük ekmek"},
		"dinner\x00oat bran":             {display: "yulaf kepekli yemeklik küçük ekmek"},
		"dinner\x00rye":                  {display: "çavdarlı yemeklik küçük ekmek"},
		"dinner\x00sweet":                {display: "tatlı yemeklik küçük ekmek"},
		"dinner\x00wheat":                {display: "buğdaylı yemeklik küçük ekmek"},
		"dinner\x00whole-wheat":          {display: "tam buğdaylı yemeklik küçük ekmek"},
		"french":                         {display: "Fransız usulü küçük ekmek"},
		"hamburger\x00whole grain white": {display: "tam tahıllı beyaz hamburger ekmeği"},
		"pumpernickel":                   {display: "pumpernickel küçük ekmeği"},
	},
	"Soft drink": {
		"chocolate flavored": {display: "çikolata aromalı gazlı içecek"},
		"cola":               {display: "kola"},
		"cream soda":         {display: "cream soda tipi gazlı içecek"},
		"fruit flavored":     {display: "meyve aromalı gazlı içecek"},
		"ginger ale":         {display: "zencefilli gazlı içecek"},
		"root beer":          {display: "root beer tipi gazlı içecek"},
	},
	"Syrups": {
		"chocolate\x00fudge-type": {display: "fudge tipi çikolata şurubu"},
		"corn\x00dark":            {display: "koyu mısır şurubu"},
		"corn\x00high-fructose":   {display: "yüksek fruktozlu mısır şurubu"},
		"corn\x00light":           {display: "açık renkli mısır şurubu"},
		"grenadine":               {display: "grenadin şurubu"},
		"malt":                    {display: "malt şurubu"},
		"maple":                   {display: "akçaağaç şurubu"},
		"sorghum":                 {display: "sorgum şurubu"},
		"table blends\x00pancake": {display: "pankek için sofra şurubu karışımı"},
	},
	"Squash": {
	...
	"Waffle": {
		"buttermilk":  {display: "yayık altı sütlü waffle"},
		"chocolate":   {display: "çikolatalı waffle"},
		"cinnamon":    {display: "tarçınlı waffle"},
		"fruit":       {display: "meyveli waffle"},
		"gluten free": {display: "glutensiz waffle"},
		"plain":       {display: "sade waffle"},
		"school":      {display: "okul yemeği waffle'ı"},
		"whole grain": {display: "tam tahıllı waffle"},
	},
	"Waffles": {
		"buttermilk":     {display: "yayık altı sütlü waffle"},
		"chocolate chip": {display: "çikolata parçacıklı waffle"},
		"gluten-free":    {display: "glutensiz waffle"},
		"plain":          {display: "sade waffle"},
		"whole wheat":    {display: "tam buğdaylı waffle"},
	},
	"Yogurt": {
		"fruit": {display: "meyveli yoğurt"},
	},
}

var safeModifiers = map[string]string{
	"barbecue flavored":         "barbekü aromalı",
	"buttered":                  "tereyağlı",
	"caffeine containing":       "kafeinli",
	"caffeine free":             "kafeinsiz",
	"calcium-fortified":         "kalsiyumla zenginleştirilmiş",
	"cheese flavored":           "peynir aromalı",
	"chocolate":                 "çikolatalı",
	"chocolate flavored":        "çikolata aromalı",
	"cooked in skin":            "kabuğunda pişirilmiş",
	"cooked with oil":           "yağla pişirilmiş",
	"cream style":               "kremamsı kıvamda",
	"creamed":                   "kremamsı kıvamda",
	"degermed":                  "ruşeymi alınmış",
	"dry mix":                   "kuru karışım",
	"dry grated":                "kuru rendelenmiş",
	"french fried":              "derin yağda kızartılmış",
	"fresh-refrigerated":        "taze ve soğutulmuş",
	"flesh":                     "etli kısmı",
	"flesh and skin":            "etli kısmı ve kabuğu",
	"flavors other than fruit":  "meyve dışındaki aromalarda",
	"for use on a sandwich":     "sandviçte kullanıma uygun",
	"from canned":               "konserveden hazırlanmış",
	"from concentrate":          "konsantreden hazırlanmış",
	"from dried":                "kurutulmuş üründen hazırlanmış",
	"from restaurant":           "restoranda hazırlanmış",
	"grilled":                   "ızgara",
	"gluten free":               "glutensiz",
	"glutinous":                 "yapışkan",
	"grated":                    "rendelenmiş",
	"home-prepared":             "evde hazırlanmış",
	"honey roasted":             "balla kavrulmuş",
	"includes from concentrate": "kısmen konsantreden hazırlanmış",
	"low carbohydrate":          "düşük karbonhidratlı",
	"low fat milk":              "az yağlı sütle hazırlanmış",
	"low-fat":                   "az yağlı",
	"kernels cut off cob":       "koçandan ayrılmış taneli",
	"kernels on cob":            "koçan üzerinde taneli",
	"multigrain":                "çok tahıllı",
	"mixed":                     "karışık",
	"no butter":                 "tereyağı eklenmemiş",
	"no sugar added":            "şeker eklenmemiş",
	"not fortified":             "zenginleştirilmemiş",
	"not from concentrate":      "konsantreden hazırlanmamış",
	"other flavored":            "diğer aromalarda",
	"oat bran":                  "yulaf kepekli",
	"pan fried in canola oil":   "kanola yağında tavada kızartılmış",
	"pan-fried in canola oil":   "kanola yağında tavada kızartılmış",
	"parboiled":                 "ön haşlanmış",
	"powdered":                  "toz",
	"pre-lightened and pre-sweetened with low-calorie sweetener": "kahve kreması ve düşük kalorili tatlandırıcı önceden eklenmiş",
	"pre-lightened and pre-sweetened with low calorie sweetener": "kahve kreması ve düşük kalorili tatlandırıcı önceden eklenmiş",
	"pre-lightened and pre-sweetened with sugar":                 "kahve kreması ve şeker önceden eklenmiş",
	"pumpernickel":                          "pumpernickel",
	"purple":                                "mor",
	"rye":                                   "çavdarlı",
	"self-rising":                           "kendiliğinden kabaran",
	"skin":                                  "kabuk",
	"sodium added":                          "sodyum eklenmiş",
	"spinach":                               "ıspanaklı",
	"soft":                                  "yumuşak",
	"soft-serve":                            "yumuşak kıvamlı",
	"sour cream and onion flavored":         "ekşi krema ve soğan aromalı",
	"stewed":                                "kısık ateşte pişirilmiş",
	"strawberry":                            "çilekli",
	"sugar free":                            "şekersiz",
	"sulfured":                              "kükürtlenmiş",
	"toaster-type":                          "tost makinesinde ısıtmaya uygun",
	"ready -to-heat":                        "ısıtmaya hazır",
	"undiluted":                             "seyreltilmemiş",
	"vacuum pack":                           "vakumlu paket",
	"vanilla":                               "vanilyalı",
	"vitamin and mineral fortified":         "vitamin ve minerallerle zenginleştirilmiş",
	"wheat bran":                            "buğday kepekli",
	"whole kernel":                          "bütün taneli",
	"whole grain white":                     "tam tahıllı beyaz",
	"whole wheat":                           "tam buğdaylı",
	"with added calcium and vitamin d":      "kalsiyum ve D vitamini eklenmiş",
	"with fruit and nuts":                   "meyve ve kuruyemişli",
	"with fruit other than raisins":         "kuru üzüm dışındaki meyvelerle hazırlanmış",
	"with high vitamin c":                   "yüksek C vitamini içeren",
	"with added sugar":                      "şeker eklenmiş",
	"with low calorie sweetener":            "düşük kalorili tatlandırıcılı",
	"fortified with vitamin d":              "D vitaminiyle zenginleştirilmiş",
	"with non-dairy milk and whipped cream": "bitkisel süt ve krem şantiyle hazırlanmış",
	"with whipped cream":                    "krem şantili",
	...
	"microwave":                             "mikrodalgada ısıtılmış",
